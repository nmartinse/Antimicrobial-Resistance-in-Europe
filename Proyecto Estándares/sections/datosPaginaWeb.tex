...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{images/trans_bacterias.JPG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{images/trans_estudio.JPG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{images/trans_mapa.png}
    \caption{Transformación tabla grupos}
    \label{transMapa}
\end{figure}
